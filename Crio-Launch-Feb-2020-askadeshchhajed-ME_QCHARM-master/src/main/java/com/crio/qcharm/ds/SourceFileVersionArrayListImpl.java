...
public class SourceFileVersionArrayListImpl implements SourceFileVersion {
  ...
  public SourceFileVersionArrayListImpl(String fileName) {
  ...
  public SourceFileVersion apply(List<Edits> edits) {
    ...
    lines.addAll(lines);
    SourceFileVersionArrayListImpl latest = new SourceFileVersionArrayListImpl(name);
  ...
  public void apply(UpdateLines updateLines) {
    ...
    //lines.subList(start, end).addAll(content);
    int j = 0;
  ...
  public List<Cursor> getCursors(SearchRequest searchRequest) {
    ...
    List<Cursor> cursorl = new ArrayList<Cursor>();
